...
basedir="/home/kanellopoulos/thesis/thesis-ad-diagnosis/tralzformer/advsrest/tralzformer_september/"

fname = 'Exp_07_09_DiagnosisPredictionFinal_Cluster1_7V_fold_5_Preds'
save_path = '/home/kanellopoulos/thesis/thesis-ad-diagnosis/tralzformer/advsrest/tralzformer_september/model_predictions/07_09_Cluster1_11_09'
dat_file = '/home/kanellopoulos/thesis/thesis-ad-diagnosis/tralzformer/advsrest/tralzformer_september/data/adni/FullCohort_Test_Cluster1.csv'
cnf_file = f'{basedir}/data/toml/diagnosis_prediction_7_visits.toml'
ckpt_path = '/home/kanellopoulos/thesis/thesis-ad-diagnosis/tralzformer/advsrest/tralzformer_september/ckpt/7_Visits/Exp_07_09_DiagnosisPredictionFinal_7V_fold_5.pt'
...
def compute_ig_batch(
    ...
    def include_key(k):
        ...
        return (k.startswith("time") and ("DX" not in k))
